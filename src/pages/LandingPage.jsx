...
const LandingPage = () => {
    ...
    const lightThemeEffectOptions = {
        ...
        colors: {
            roadColor: 0xe5e7eb, // Light gray road
            islandColor: 0xd1d5db, // Slightly darker gray island
            background: 0xf9fafb, // Off-white background
            shoulderLines: 0x6b7280, // Medium-gray shoulder lines
            brokenLines: 0x9ca3af, // Lighter gray broken lines
            leftCars: [0xef4444, 0xf97316, 0xd946ef], // Red, Orange, Fuchsia car lights
            rightCars: [0x10b981, 0x3b82f6, 0x8b5cf6], // Emerald, Blue, Violet car lights
            sticks: 0x0ea5e9, // Sky blue light sticks
        }
    };
    ...
    const features = [
        {
            ...
            description: "Auto matches you with internships that align with your career goals and skills."
        },
        {
        ...
        
        {
            ...
            icon: <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01V5M12 20v-1m0-1v-1m0-1V4m0 16v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1m0-1v-1M6 9.01V9M6 15v-.01M18 9.01V9m0 6v-.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>,
            title: "Career Swap",
