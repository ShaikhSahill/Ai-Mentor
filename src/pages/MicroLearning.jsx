...
const learningFormats = [
    { id: 'lesson', title: 'Quick Lesson', duration: '5-15 minutes', icon: <QuickLessonIcon /> },
    { id: 'module', title: 'Module', duration: '30-60 minutes', icon: <ModuleIcon /> },
    { id: 'roadmap', title: 'Full Roadmap', duration: 'Multi-week plan', icon: <RoadmapIcon /> },
];
...
const MicroLearning = () => {
    ...
    const [selectedFormat, setSelectedFormat] = useState('module'); // 'module' is selected by default
