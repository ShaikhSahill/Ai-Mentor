...
const Register = () => {
    ...
    return (
        <div className="h-100vh bg-gray-50 flex items-center justify-center p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 max-w-6xl w-full mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div className="hidden md:flex flex-col justify-center p-12 space-y-8">
                    ...
                    <div className="w-full">
                        {/* Using an illustration from unDraw - a great resource for free illustrations */}
                        <img 
                          src={aiImage}
                        //src="https://miro.medium.com/v2/resize:fit:1200/1*TAYxY-DmPwYKekjzVOD7Sg.jpeg" 
                          alt="AI Learning Illustration" 
                          className="w-full h-auto object-cover" 
                        />
                        {/* Recommended to replace placeholder with a real SVG illustration like from undraw.co, storyset.com etc. */}
                    </div>
                </div>
                ...
                <div className="w-full p-8 sm:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-gray-500 mt-2 mb-6">Create your account for an enhanced experience at your fingertips.</p>
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="password" a className="block text-sm font-medium text-gray-700 mb-1">Create a Password</label>
                        ...
                        <button 
                            type="submit" 
                            className="w-full bg-gradient-to-r from-cyan-400 to-green-400 text-white font-bold py-3 px-4 rounded-md hover:opacity-90 transition-opacity duration-200 cursor-pointer"
                        >
                            Sign Up
                        </button>
                    </form>
